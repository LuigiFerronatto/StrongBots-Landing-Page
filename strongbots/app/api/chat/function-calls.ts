...
// Update the ScheduleResponse interface to include the missing properties
export interface ScheduleResponse {
  ...
  fallback?: boolean
  alternativeSuggestions?: string[] // Add this property
  availableSlots?: string[] // Add this property
